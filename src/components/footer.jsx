      ...
      <div className="container-main section-padding pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-display text-3xl font-semibold mb-2">Lumière</h3>
            <p className="text-rose-light/80 text-sm leading-relaxed mb-6">
              Discover the art of radiant beauty. Premium cosmetics crafted with care for your skin's natural glow.
            </p>
            <div className="flex gap-4">
              {[FaInstagram, FaFacebook, FaTwitter].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-rose-dark transition-colors duration-300">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-rose-light/50 text-xs">&copy; {new Date().getFullYear()} Lumière Beauty. All rights reserved.</p>
